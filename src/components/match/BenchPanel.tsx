...
export function BenchPanel({ children, unavailableSection, count }: BenchPanelProps) {
  ...
  return (
    <div className="flex flex-col sm:h-full sm:min-h-0">
      <h2 className="shrink-0 text-sm font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">
      ...
      <div
        ...
        className={clsx(
          ...
          'mt-2 grid min-h-[6rem] grid-cols-2 content-start gap-2 overflow-y-auto rounded-lg border-2 border-dashed border-slate-300 p-3 dark:border-slate-600 sm:min-h-0 sm:flex-1',
